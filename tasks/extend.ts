...
import { ExtendLogic__factory } from "../src/types/factories/ExtendLogic__factory";
...
task("extend")
  ...
  .setAction(async function (taskArguments: TaskArguments, { ethers }) {
    const extendLogicFactory: ExtendLogic__factory = <ExtendLogic__factory>await ethers.getContractFactory("ExtendLogic");
