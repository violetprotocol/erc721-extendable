    ...
    describe("token URI", function () {
      ...
      describe("unpermissioned", async function () {
        ...
        it("reverts when queried for non existent token id", async function () {
          await expect(this.tokenAsMetadataGetter.tokenURI(nonExistentTokenId)).to.be.revertedWith(
        ...
        it("reverts when setting for non existent token id", async function () {
          await expect(this.tokenAsSetTokenURI.setTokenURI(nonExistentTokenId, sampleUri)).to.be.revertedWith(
        ...
        context("base URI", function () {
          ...
          it("tokens without URI can be burnt ", async function () {
            ...
            await expect(this.tokenAsMetadataGetter.tokenURI(firstTokenId)).to.be.revertedWith(
              "ERC721URIStorage: URI query for nonexistent token",
            );
          });
        ...
        context("base URI", function () {
          ...
          context("as non-owner", async function () {
            ...
            it("set base URI reverts", async function () {
              await expect(this.tokenAsSetTokenURI.connect(this.signers.other).setBaseURI(BASE_URI)).to.be.revertedWith(
